                ...
                <!--搜索-->
                  <div class="breadcrumb ccsearch">
					  <form action="{{ url('admin/bill') }}" method="get">
						  ...
						  <input type="text" class="form-control ccdates"  style="width: 400px;" value="@if(isset($_GET['keyword'])){{ $_GET['keyword'] }}@endif" name="keyword" placeholder="项目名/品名/经手人/备注/关键词查询">
