...
//操作提示
$(".sp_prompt h3").click(function()	{
	$(this).siblings(".sp_pro_lst").toggle();
});

//一级分类列表折叠
  $(".cradre").click(function(){
	 if($(this).hasClass("fa-plus-square-o"))
	 {
	   $(this).removeClass("fa-plus-square-o");
	   $(this).addClass("fa-minus-square-o");
		$(this).parent().parent("tr").siblings("tr").show();
	  }
	 else if ($(this).hasClass("fa-minus-square-o"))
	 {
	   $(this).removeClass("fa-minus-square-o");
	   $(this).addClass("fa-plus-square-o");
		$(this).parent().parent("tr").siblings("tr").hide();
		 }
});
$(".creat").click(function(){
	if($(this).hasClass("fa-plus-square-o"))
	{
		$(this).removeClass("fa-plus-square-o");
		$(this).addClass("fa-minus-square-o");
		$(this).parent().parent("tr").siblings("tr").children().children("ul").show();
	}
	else if ($(this).hasClass("fa-minus-square-o"))
	{
		$(this).removeClass("fa-minus-square-o");
		$(this).addClass("fa-plus-square-o");
		$(this).parent().parent("tr").siblings("tr").children().children("ul").hide();
	}
});
